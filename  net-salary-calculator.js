...
let kratax=(basicSalary,benefits)=>{
    let nssf=0
    let nhif =0

    function benefitsfunction(basicSalary,benefits){
        nssf= basicSalary=0.5
        nhif= basicSalary
    }

grossSalary = 75000
nssf = (75000 * 0.06) = 4500
nhif = (1400 * 0.15) = 210 * 75000 - (nssf + nhif)
let taxableIncome = 75000 - (nssf + nhif)
...
function kratax(basicSalary, benefits){
    ...
    function benefits(basicSalary, benefits = 0){
        let  nhifDeduction = 0
